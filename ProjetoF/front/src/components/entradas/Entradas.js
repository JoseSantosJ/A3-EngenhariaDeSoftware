...
function Entradas(){
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:8080/listarentrada")
...
const aoDigitar = (e) => {
  ...
  //cadastrar Entrada
  const cadastrar = () => {
    fetch('http://localhost:8080/cadastrarentrada',/* normalmente fetch requisita funções GET mas como sera requisitado outra forma de methodo a ",{}" para passar as caracteristicas complementares*/{
      method: 'post',
  ...
  //Remover entrada
  const remover = () => {
    fetch('http://localhost:8080/removerentrada/'+objEntrada.codigo,/* normalmente fetch requisita funções GET mas como sera requisitado outra forma de methodo a ",{}" para passar as caracteristicas complementares*/{
      method: 'delete',
      headers:{
        'Content-type':'application/json',
        'accept':'application/json'
  ...
  //alterar Entrada
  const alterar = () => {
    fetch('http://localhost:8080/alterarentrada',/* normalmente fetch requisita funções GET mas como sera requisitado outra forma de methodo a ",{}" para passar as caracteristicas complementares*/{
      method: 'put',
      body:JSON.stringify(objEntrada),
      headers:{
        'Content-type':'application/json',
